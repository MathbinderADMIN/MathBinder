...
final class MathBinder_Class_Staff {
    ...
    public static function register() {
        ...
        add_action('admin_post_mb_invite_class_staff', [__CLASS__, 'handle_invite']);
    ...
    public static function handle_invite() {
        ...
        check_admin_referer('mb_invite_class_staff', 'mb_staff_nonce');
        global $wpdb;
        ...
        $wpdb->insert($wpdb->prefix.'mb_class_staff_invites', ['staff_access_id'=>$staff_id,'token_hash'=>hash('sha256',$token),'invited_email'=>$email,'status'=>'pending','expires_at'=>$invite_expires,'created_by'=>$actor,'created_at'=>$now]);
