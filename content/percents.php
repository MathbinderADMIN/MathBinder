...
return array(
    ...
    'version' => '1.0.0',
    'title' => 'Percents',
    'overview' => 'Students learn to understand, calculate, and apply percents. The lesson covers conversions, percent proportions and equations, markups, discounts, sales tax, tips, percent change, original amounts, and multi-step real-world problems.',
    'teach_it' => 'A percent is a ratio that compares a number to 100. The word percent means per hundred. For example, 35% means 35 out of 100, or 35/100. This can also be written as the decimal 0.35.
...
Common misconceptions and corrections: Convert the percent to a decimal before multiplying, identify the correct whole, use the original value when calculating percent change, subtract discounts, add markups and taxes, and perform multi-step calculations in the order described.',
    ...
    'my_math_notes' => array(
        'Percent means per hundred.',
        'Part = percent × whole.',
        'Write the percent as a decimal before multiplying.',
        'Use part divided by whole to find the percent.',
        'Use part divided by percent to find the whole.',
        'Discounts are subtracted from the original price.',
        'Markups, taxes, and tips are added.',
        'Percent change = amount of change divided by the original value.',
        'Use 1 plus the rate for an increase and 1 minus the rate for a decrease.',
        'Apply each step to the correct amount in a multi-step problem.'
    ),
    'ixl' => "Percent Change Lesson | https://www.ixl.com/math/lessons/percent-change\nWhat Percentage Is Illustrated? | https://www.ixl.com/math/grade-6/what-percentage-is-illustrated\nPercents Lesson | https://www.ixl.com/math/lessons/percents\nPercents of Numbers and Money Amounts | https://www.ixl.com/math/grade-6/percents-of-numbers-and-money-amounts\nCalculate Tax, Tip, Markup, and More | https://www.ixl.com/math/grade-6/percents-calculate-tax-tip-mark-up-and-more",
    'khan' => "Describing the Meaning of Percent | https://www.khanacademy.org/math/6th-engage-ny/engage-6th-module-1/6th-module-1-topic-d/v/describing-the-meaning-of-percent\nIntro to Percents | https://www.khanacademy.org/math/cc-sixth-grade-math/x0267d782:cc-6th-rates-and-percentages/cc-6th-percentages/e/intro-to-percents\nBenchmark Percents | https://www.khanacademy.org/math/cc-sixth-grade-math/x0267d782:cc-6th-rates-and-percentages/x0267d782:equivalent-representations-of-percent-problems/e/benchmark-percents\nRelate Fractions, Decimals, and Percents | https://www.khanacademy.org/math/algebra-basics/basic-alg-foundations/alg-basics-decimals/e/relate-fractions--decimals--and-percents",
    'delta' => "Percent of a Whole | https://www.deltamath.com/app/teacher/solve/1775020\nPercent More or Less (Formula) L1 | https://www.deltamath.com/app/teacher/solve/2133718\nFind Percent Increase/Decrease | https://www.deltamath.com/app/teacher/solve/1714723\nPercent Error | https://www.deltamath.com/app/teacher/solve/1269376",
    'real_life_math' => 'Percents are used when shopping, calculating discounts and sales tax, leaving tips, determining markups, comparing price changes, calculating interest, analyzing grades, measuring growth or decline, and interpreting statistics.',
    'did_you_know' => 'A percent greater than 100% is possible. For example, if a quantity becomes two and one-half times its original amount, the new quantity is 250% of the original.'
);
