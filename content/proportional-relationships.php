...
return array(
    ...
    'overview' => 'Students learn how to identify, represent, and interpret proportional relationships. They use equivalent ratios, tables, graphs, and equations to determine constants of proportionality and solve real-world problems.',
    'teach_it' => 'A proportional relationship connects two quantities whose ratios remain equivalent. As one quantity changes, the other changes at a constant rate. For example, if each notebook costs $3, then 1 notebook costs $3, 2 notebooks cost $6, and 5 notebooks cost $15. The ratio of cost to number of notebooks is always 3 to 1.
...
Common misconceptions and corrections: Students may assume that every straight-line graph is proportional, compare differences instead of ratios, divide in the wrong order, or confuse the constant of proportionality with one of the original quantities. Check for a constant ratio, verify that the graph passes through the origin, divide in the order indicated by the desired units, and explain what the constant represents in context.',
    ...
    'my_math_notes' => array(
        'Proportional relationships have equivalent ratios and a constant unit rate.',
        'Find the constant of proportionality by dividing y by x.',
        'Write a proportional equation in the form y = kx.',
        'The value of k must include units and be interpreted in context.',
        'A proportional graph is a straight line through the origin.',
        'A linear relationship that does not pass through the origin is not proportional.'
    ),
    'ixl' => "Proportional Relationships Lesson | https://www.ixl.com/math/lessons/proportional-relationships\nIdentify Proportional Relationships from Tables | https://www.ixl.com/math/grade-7/identify-proportional-relationships-from-tables\nIdentify Proportional Relationships by Graphing | https://www.ixl.com/math/grade-7/identify-proportional-relationships-by-graphing\nIdentify Proportional Relationships from Equations | https://www.ixl.com/math/grade-7/identify-proportional-relationships-from-equations\nComplete a Table and Graph a Proportional Relationship | https://www.ixl.com/math/grade-7/complete-a-table-and-graph-a-proportional-relationship",
    'khan' => "Lesson 3: Identifying Proportional Relationships | https://www.khanacademy.org/math/cc-seventh-grade-math/cc-7th-ratio-proportion/cc-7th-proportional-rel/v/introduction-to-proportional-relationships\nIdentify Proportional Relationships from Graphs | https://www.khanacademy.org/math/cc-seventh-grade-math/cc-7th-ratio-proportion/cc-7th-graphs-proportions/e/identify-proportional-relationships-from-graphs\nGraphing Proportional Relationships | https://www.khanacademy.org/math/cc-eighth-grade-math/cc-8th-linear-equations-functions/cc-8th-graphing-prop-rel/e/graphing-proportional-relationships\nWriting Proportional Equations | https://www.khanacademy.org/math/cc-seventh-grade-math/cc-7th-ratio-proportion/cc-7th-equations-of-proportional-relationships/e/writing-proportional-equations",
    'delta' => "Simple Proportions: Positive | https://www.deltamath.com/app/teacher/solve/3198646\nMake Table, Write Equation: Proportional Context Guided | https://www.deltamath.com/app/teacher/solve/3164051\nGraph Proportional Equation | https://www.deltamath.com/app/teacher/solve/3299299\nEquation of a Proportional Graph | https://www.deltamath.com/app/teacher/solve/3010087",
    'real_life_math' => 'Proportional relationships are used to calculate prices, wages, distances, recipe amounts, scale drawings, measurement conversions, fuel consumption, and other situations involving a constant rate.',
    'did_you_know' => 'Maps and architectural drawings use proportional relationships. Every measurement in a scale drawing corresponds to an actual measurement using the same constant scale factor.'
);
