...
final class MathBinder_Canvas_Transport {
    ...
    public static function config(){
        ...
        return ['title'=>'MathBinder','description'=>'California standards-aligned mastery paths, evidence, and progress','oidc_initiation_url'=>$base.'oidc/login','target_link_uri'=>$base.'lti/launch','public_jwk_url'=>$base.'jwks','scopes'=>['https://purl.imsglobal.org/spec/lti-ags/scope/lineitem','https://purl.imsglobal.org/spec/lti-ags/scope/score','https://purl.imsglobal.org/spec/lti-nrps/scope/contextmembership.readonly'],'extensions'=>[['platform'=>'canvas.instructure.com','settings'=>['placements'=>[['placement'=>'course_navigation','message_type'=>'LtiResourceLinkRequest','target_link_uri'=>$base.'lti/launch'],['placement'=>'assignment_selection','message_type'=>'LtiDeepLinkingRequest','target_link_uri'=>$base.'lti/launch'],['placement'=>'homework_submission','message_type'=>'LtiDeepLinkingRequest','target_link_uri'=>$base.'lti/launch']]]]],'public_jwk'=>json_decode((string)(MathBinder_Canvas_Settings::get()['public_jwk']??'{}'),true)];
    }
