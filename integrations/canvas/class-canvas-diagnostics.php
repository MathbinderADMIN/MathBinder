...
final class MathBinder_Canvas_Diagnostics {
    ...
    public static function local_tests() {
        ...
        $tests = [
            ...
            self::test('mode', 'Operating mode is fail-closed', in_array(($s['operating_mode'] ?? 'disabled'), ['disabled','sandbox'], true), 'Core 30.51.5 permits gated sandbox transmission; production remains locked until certification.'),
