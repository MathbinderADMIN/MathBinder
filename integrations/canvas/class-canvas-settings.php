...
final class MathBinder_Canvas_Settings {
    ...
    public static function render() {
        ...
        <div class="wrap"><h1>MathBinder Canvas Sandbox</h1>
            ...
            <div class="notice <?php echo $s['sandbox_enabled'] ? 'notice-success' : ($complete ? 'notice-info' : 'notice-warning'); ?> inline"><p><strong><?php echo $s['sandbox_enabled'] ? 'Canvas sandbox transmission gate is enabled.' : ($complete ? 'Configuration is complete but transmission is disabled.' : 'Canvas sandbox is not configured.'); ?></strong></p><p>Core 30.51.5 can authenticate approved mapped users inside embedded Canvas lessons, return teacher-selected lessons, accept and record Canvas-linked student assignment snapshots, and send teacher-approved test grades only after every gate and mapping is approved. Production transmission remains disabled until the sandbox certification checklist is completed.</p></div>
