    ...
    public static function shortcode() {
        ...
        <main class="mb-login-page">
            <section class="mb-login-card" aria-labelledby="mb-login-title">
                ...
                <p class="mb-login-intro">Use your MathBinder account. Students, parents, and teachers can choose the correct signup path.</p>
                ...
                <p class="mb-login-help">Don’t have an account? <a href="<?php echo esc_url(home_url('/sign-up/')); ?>">Choose your signup type.</a></p>
            </section>
        </main>
